...
Usage
Prepare your documents: Place your legal PDF documents in the /data/raw directory

Start the chatbot: Run the main application:

uv run app.py
Interact with the bot: The terminal interface will start, and you can begin asking questions. Type exit to quit.
How It Works
...
API Keys Required
Cohere API Key: Required for the chat model (sign up at Cohere)
OpenAI API Key: Optional, if you want to switch to OpenAI models
Developer
Developed by Sougat Dey
